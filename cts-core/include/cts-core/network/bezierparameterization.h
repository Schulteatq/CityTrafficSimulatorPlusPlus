...
namespace cts { namespace core
{
	 ...
	 * It is defined by a Bézier curve defined by four support points. This class provides various
	...
	public:
		...
		/// \param	time    Location on this curve in terms of arc position (dm).
